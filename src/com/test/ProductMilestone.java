...
public class ProductMilestone {
    ...
    public String getHtmlCode() {
        ...
        htmlString = htmlString.replaceAll(CONST_HTML_CODE.PLACEHOLDER_MILESTONE_STATUS_CODE, (status == MILESTONE_STATUS.READY) ? CONST_HTML_CODE.PLACEHOLDER_MILESTONE_STATUS_REDY_CODE : CONST_HTML_CODE.PLACEHOLDER_MILESTONE_STATUS_DONE_CODE);
