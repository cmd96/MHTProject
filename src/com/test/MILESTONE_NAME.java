...
public class MILESTONE_NAME
{
    public static int DRAFT   = 1;
    public static int OUTLINE = 2;
    public static int DRAFT_1 = 3;
    public static int DRAFT_2 = 4;
    public static int CR = 5;
    public static int SYLLABUS = 6;
    public static int PRESENTATION = 7;
    public static int TEST = 8;
    public static int COURSE = 9;
